...
import com.uamishop.ventas.ApiError;
...
public class CarritoController {
        ...
        @Operation(summary = "Obtener carrito en checkout por cliente", description = "Endpoint interno para que el MS de Órdenes obtenga el resumen del carrito en proceso de checkout.")
        @GetMapping("/checkout/cliente/{clienteId}")
        public ResponseEntity<com.uamishop.ventas.dto.CarritoResumen> obtenerCarritoParaCheckout(
                        @Parameter(description = "ID del cliente") @PathVariable java.util.UUID clienteId) {
                return carritoService.obtenerCarritoParaCheckout(clienteId)
