...
public class CarritoController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Error de validación en los datos", content = @Content(schema = @Schema(type = "string")))
    })
    @PostMapping
    ...
    @Operation(summary = "Obtener carrito", description = "Obtiene los detalles de un carrito existente por su ID.")
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Carrito no encontrado", content = @Content(schema = @Schema(type = "string")))
    })
    @GetMapping("/{id}")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Error de validación o regla de negocio violada (ej: cantidad fuera de rango, carrito no activo)", content = @Content(schema = @Schema(type = "string")))
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Error de validación o producto no encontrado en el carrito", content = @Content(schema = @Schema(type = "string")))
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Producto no encontrado en el carrito o carrito no modificable", content = @Content(schema = @Schema(type = "string")))
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "El carrito no está en estado ACTIVO", content = @Content(schema = @Schema(type = "string")))
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "No se cumplen las condiciones para checkout (carrito vacío, total insuficiente, estado inválido)", content = @Content(schema = @Schema(type = "string")))
    })
